/**
 * ai-recipe-idea.js
 * Sends fridge ingredients to OpenAI and displays 0–3 recipe suggestions as JSON.
 *
 * Dev note: API key is embedded for local / private use. Anyone with the page source can see it;
 * rotate the key if this repo is shared or deployed publicly.
 */
